    ...
    <section className="py-24 bg-gradient-to-b from-luxury-beige to-white border-b border-luxury-beigeDark/30 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            We create cohesive interiors that balance aesthetics, functionality and individuality — and design exteriors that make a strong first impression. We provide end-to-end design and execution solutions for residential, commercial, hospitality, and educational spaces across Kolkata.
          </motion.p>
        </div>
