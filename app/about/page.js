          ...
          <div className="mt-24 p-8 sm:p-12 rounded-3xl bg-white border border-luxury-beigeDark/65 hover:border-luxury-gold/40 shadow-[0_20px_50px_rgba(212,175,55,0.1)] flex flex-col md:flex-row gap-8 items-start relative overflow-hidden group transition-all duration-500 scale-100 hover:scale-[1.01]">
            ...
            <div className="flex-grow">
              ...
              <p className="text-luxury-charcoalLight font-semibold text-sm sm:text-base leading-relaxed mb-5">
                We combine thoughtful design, quality materials, skilled execution, and reliable project management to deliver spaces that are built to last. From trusted brands to experienced workmanship, we ensure every detail meets our standards of quality and finish.<br/> <br/>With end-to-end design and execution under one roof, we provide a seamless experience from concept to completion — giving our clients confidence, transparency, and peace of mind.
              </p>
